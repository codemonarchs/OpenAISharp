namespace OpenAISharp.Utilities.Constants
{
    public static class KnownModelNames
    {
        ...
        public const string DavinciIf_300 = "davinci-if:3.0.0";
        public const string DavinciInstructBeta = "davinci-instruct-beta";
        public const string DavinciInstructBeta_200 = "davinci-instruct-beta:2.0.0";
        ...
        public const string IfDavinci_300 = "if-davinci:3.0.0";
